...
class Start:
    ...
    def start_flask(self):
        ...
        for counter, port in enumerate(Globals.FLASK_PORTS):
            flask_command = ['flask', 'run', '--port', str(port), '&']
    ...
    def execute_process(self, command):
        ...
        """
        proc = subprocess.Popen(command, stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True, env=os.environ)
